...
public class CameraPosition : MonoBehaviour
{
    ...
    [SerializeField] private SquadObject targetUnit;
    ...
    public void RotateRig(float newValue, float multiplier = 1)
    {
        ...
        newRotation = Quaternion.RotateTowards(transform.rotation, newRotation, (RotationSpeed * multiplier) * Time.deltaTime);
        transform.localRotation = newRotation;
    }

    public void SetTargetUnit(SquadObject newTarget)
    {
